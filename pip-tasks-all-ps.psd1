...
GUID = '7a5533b0-432d-49c8-b7a0-cd14b2106a4c'
...
Description = 'Integration Powershell module for Pip.Tasks'
...
RequiredModules = @('pip-tasks-ps', 'pip-tasks-common-ps', 'pip-tasks-dotnet-ps', 'pip-tasks-java-ps', 'pip-tasks-python-ps')
